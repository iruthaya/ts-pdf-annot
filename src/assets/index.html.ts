  ...
  <div id="main-container" tabindex="0" class="hide-previewer disabled" 
    ...
    <div id="top-panel"> 
      ...
      <div id="modes" class="subpanel panel-item">
       <div id="button-mode-text" class="panel-button panel-item dis-none">
          <img src="${Icons.icon_caret}"/>
        </div> 
        <div id="button-mode-hand" class="panel-button panel-item dis-none">
          <img src="${Icons.icon_hand}"/>
         </div>
        <div id="button-mode-annotation" class="panel-button panel-item">
          <img src="${Icons.icon_popup}"/>
        </div> 
        <div id="button-mode-comparison" class="panel-button panel-item dis-none">
    ...
    <div id="annotation-panel">
      ...
      <div class="annotation-panel-row dis-none">
